...
- **Horas acumuladas**: +741 horas de práctica en entornos ofensivos  
  Experiencia práctica documentada en criptografía, pentesting y seguridad ofensiva.

- **Labs destacados**:  
  - HMAC Weak Key Demo  
  - Unauthenticated Encryption & Bit-Flipping Attack  
  - Client-Side Key Exposure Exploit  
  - AES-CBC Manipulation Demo
